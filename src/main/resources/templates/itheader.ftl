        ...
        <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
            ...
            <ul class="nav navbar-nav navbar-right">
                <#if user??>
                    ...
                    <li class=""><a href="${contextPath}/python">Python</a></li>
                    <li class=""><a href="${contextPath}/c++">c</a></li>
                    <li class=""><a href="${contextPath}/java">java</a></li>
                    <li class="">
                        <a href="${contextPath}/more"> 更多 </a>
                    </li>
